...
class _Software_engState extends State<Software_eng> {
  String content =
      "This report provides an overview of the thrid-year software computer class lab. The lab has a total of 14 computers, of which 13 are currently working and 1 Hp desk top core I 3 are not working. The working computers include 13 core i3, 10 core i5 systems. The non-working computers have been reported to the lab technician and are undergoing repair. The lab is used by thrid year software engineering students for coding, programming, and other related coursework. The lab administrator will continue to monitor the lab's status and ensure that all computers are functioning properly. Students are encouraged to report any issues they encounter to the lab technician for prompt resolution. The lab is an essential resource for students, and efforts will be made to ensure its optimal functionality.";
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("3rd year's Software Lab"),
