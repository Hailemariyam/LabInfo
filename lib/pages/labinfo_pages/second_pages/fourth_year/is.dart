...
class _Information_sysState extends State<Information_sys> {
  String content =
      "This report provides an overview of the fourth-year information sytem  computer class lab. The lab has a total of 25 computers, of which all are currently working.  The working computers include 25  core i7 systems. The non-working computers have been reported to the lab technician and are undergoing repair. The lab is used by fourth-year information sytem  students for coding, programming, and other related coursework. The lab administrator will continue to monitor the lab's status and ensure that all computers are functioning properly. Students are encouraged to report any issues they encounter to the lab technician for prompt resolution. The lab is an essential resource for students, and efforts will be made to ensure its optimal functionality.";
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("4th year's IS Lab"),
