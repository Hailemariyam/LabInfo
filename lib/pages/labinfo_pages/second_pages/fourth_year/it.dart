...
class _Information_techState extends State<Information_tech> {
  String content =
      "This report provides an overview of the fourth-year information technology  computer class lab report . The lab has a total of 24 computers, of which 24 are currently working and . The working computers include 20core i7 systems. The lab is used by fourth year  information technology  students for coding, programming, and other related coursework. The lab administrator will continue to monitor the lab's status and ensure that all computers are functioning properly. Students are encouraged to report any issues they encounter to the lab technician for prompt resolution. The lab is an essential resource for students, and efforts will be made to ensure its optimal functionality.";
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("4th year's IT Lab"),
